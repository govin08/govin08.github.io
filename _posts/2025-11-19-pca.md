...
많이 쓰이는 알고리즘이고 선형대수에서 바로 이어질 수 있는 기법이기 때문에 설명된 자료들이 워낙 많다.
어제(11/18)까지는 PCA와 관련된 논문[A Tutorial on Principal Component Analysis](https://arxiv.org/abs/1404.1100)을 읽었다.
