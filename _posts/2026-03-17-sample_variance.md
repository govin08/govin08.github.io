...
이다.
매우 놀라운 결과가 아닐 수 없다.
아니 놀라울 것이 없이, 당연한 결과이긴 한데, 막상 진실을 마주하니 참 놀랍다.
