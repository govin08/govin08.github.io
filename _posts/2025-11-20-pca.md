...
하지만, 당장은 출근해야 하니 나중에 이어가야지. of 

# 1. Preliminaries

## 1.1 Equivalence : Maximizing variance and mimimizing distances.
...
## 1.5 Eigen-decomposition

# 2. PCA (problem formulation)

## 2.1 (Definition of) PCA

## 2.2 PCA and lagrange multiplier

# 3. PCA (solution)

## 3.1 PCA with orthogonal diagonalization

## 3.2 PCA with singular value decomposition