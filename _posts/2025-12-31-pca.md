...
orthogonal diagonalization을 사용하면 eigenvalue들과 eigenvector들을 얻어낼 수 있다.


<div class="notice--info">
$C$의 eigenvalue들을 크기 순으로 나열해 $\lambda_1\ge\lambda_2\ge\cdots\ge\lambda_m\ge0$이고 이에 대응되는 eigenvector들이 $v_1$, $v_2$, $\cdots$, $v_m$이라면, $X$의 $i$번째 주성분은 $Xv_i$이다. ($1\le i\le m$)
</div>
